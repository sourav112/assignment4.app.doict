...
const Registrationpage = () => {
  ...
  return (
    ...
    <div class="bg-white shadow-md dark:shadow-gray-600 rounded px-8 pt-6 pb-8 mb-4 flex flex-col w-full md:w-1/3 ">
        <h1 class="text-2xl font-semibold mb-4 text-center text-gray-900 ">Registration</h1>
        <form
        ...
        >
            <div class="mb-4">
                ...
                <input class="shadow appearance-none border rounded-md w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline " id="name" name='name' type="text" placeholder="Name"/>
            </div>
            <div class="mb-4">
                <label class="block text-gray-700  text-sm font-bold mb-2" htmlFor="photo">
                    Image URL <span class="text-red-500">*</span>
                </label>
                <input class="shadow appearance-none border rounded-md w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline " id="photo" name='photo' type="text" placeholder="Image URL"/>
            </div>
            <div class="mb-4">
