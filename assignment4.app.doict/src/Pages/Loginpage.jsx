    ...
    <div class="bg-white shadow-md dark:shadow-gray-600 rounded px-8 pt-6 pb-8 mb-4 flex flex-col w-full md:w-1/3 dark:bg-gray-800">
        ...
        >
            ...
            <div class="items-center justify-between">
                ...
                <button onClick={handleGoogleSignin} class="btn btn-ghost btn-outline w-full mt-2" type="button">
                <FontAwesomeIcon icon={faGoogle}/> Continue With Google
                </button>
                <button onClick={handleGitHubSignin} class="btn btn-ghost btn-outline w-full mt-2" type="button">
